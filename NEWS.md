## 2.1.4 2022-03-11
Revert features intended for 2.2.0 only:
* Revert [SIP2-107](https://issues.folio.org/browse/SIP2-107): Support circulation interface v13
* Revert [SIP2-106](https://issues.folio.org/browse/SIP2-106): Adapt module to TLR (#71)"
